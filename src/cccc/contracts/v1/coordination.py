...
ERR_DELIVERY_NOT_FOUND = "DELIVERY_NOT_FOUND"
ERR_DELIVERY_NOT_EXECUTABLE = "DELIVERY_NOT_EXECUTABLE"
ERR_DELIVERY_OWNER_MISMATCH = "DELIVERY_OWNER_MISMATCH"
ERR_RUN_ALREADY_EXISTS = "RUN_ALREADY_EXISTS"
ERR_RUN_ALREADY_EXECUTED = "RUN_ALREADY_EXECUTED"
ERR_RUN_CANCELLED = "RUN_CANCELLED"
ERR_RUN_TIMED_OUT = "RUN_TIMED_OUT"
ERR_TASK_MESSAGE_NOT_FOUND = "TASK_MESSAGE_NOT_FOUND"
ERR_TASK_MESSAGE_KIND_INVALID = "TASK_MESSAGE_KIND_INVALID"
ERR_TASK_RECIPIENT_MISMATCH = "TASK_RECIPIENT_MISMATCH"
ERR_TASK_SENDER_NOT_FOREMAN = "TASK_SENDER_NOT_FOREMAN"
ERR_TASK_RECIPIENT_NOT_PEER = "TASK_RECIPIENT_NOT_PEER"
...
_ERROR_MESSAGES: Dict[str, str] = {
    ...
    ERR_DELIVERY_NOT_FOUND: "delivery not found",
    ERR_DELIVERY_NOT_EXECUTABLE: "delivery is not in an executable state",
    ERR_DELIVERY_OWNER_MISMATCH: "delivery is reserved by another consumer",
    ERR_RUN_ALREADY_EXISTS: "run already exists for this message",
    ERR_RUN_ALREADY_EXECUTED: "run already executed for this message and actor",
    ERR_RUN_CANCELLED: "run was cancelled",
    ERR_RUN_TIMED_OUT: "run timed out",
    ERR_TASK_MESSAGE_NOT_FOUND: "task message not found",
    ERR_TASK_MESSAGE_KIND_INVALID: "task message kind is not task_instruction",
    ERR_TASK_RECIPIENT_MISMATCH: "task message recipient does not match the executing actor",
    ERR_TASK_SENDER_NOT_FOREMAN: "task message sender is not the group foreman",
    ERR_TASK_RECIPIENT_NOT_PEER: "task message recipient is not an enabled peer actor",
